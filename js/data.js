...
const DATA = [
    // 鼈蠊屬
    {genus:"Therea", species:"olegrandjeani", latin:"Therea olegrandjeani", cn:"問號蜚蠊", stock: "in-stock", appearance: "斑點", price: 450, pack: 6, features:"黑底翅面中央白色問號狀斑紋", origin:"印度", habit:"此物種為地棲性，幼蟲與成蟲都會將大部分時間埋藏在底材中。成年雄性有時會爬到地表的樹枝上活動 。雌性將卵鞘直接產在底材中，孵化時間約需三到五個月", diet:"高蛋白犬/貓/雞飼料、水果、昆蟲果凍", temp:"24–30°C；60–80%（需乾濕分明）", diff:2, tags:["現貨","新手+"], info:"需提供濕度梯度以避免脫皮不良", img:"images/IMG_9564.JPG"},
    ...
    {genus:"Therea", species:"regularis", latin:"Therea regularis", cn:"多米諾橘骨牌蜚蠊", stock: "in-stock", appearance: "斑點", price: 700, pack: 6, features:"黑底搭配橘白斑，對比強烈", origin:"印度", habit:"此物種為地棲性，幼蟲與成蟲都會將大部分時間埋藏在底材中。成年雄性有時會爬到地表的樹枝上活動 。雌性將卵鞘直接產在底材中，孵化時間約需三到五個月", diet:"高蛋白犬/貓/雞飼料、水果、昆蟲果凍", temp:"24–30°C；60–70%", diff:1, tags:["現貨","新手友善"], info:"容錯率高，新手適合", img:"images/IMG_9554.JPG"},
    {genus:"Therea", species:"cf_irreperta", latin:"Therea cf. irreperta", cn:"Therea cf. irreperta", stock: "out-of-stock", appearance: "斑點", features:"黑底對稱橘斑，與橘骨牌相似", origin:"印度", habit:" 屬於地棲性物種，日間潛伏於底材中，夜間才會出來活動 。此物種在同屬中較為特殊，因為雌雄兩性皆具備相對較長的翅膀，且有飛行能力", diet:"高蛋白犬/貓/雞飼料、水果、昆蟲果凍", temp:"24–30°C；需乾濕交界區", diff:2, tags:["缺貨"], info:"底材濕度控制重要", img:"images/IMG_9483.jpeg"},
    // 瓷蠊屬
    {genus:"Gyna", species:"caffrorum", latin:"Gyna caffrorum", cn:"卡佛爾瓷蠊", stock: "in-stock", appearance: "質感", price: 300, pack: 6, features:"淡米至淺棕翅，細緻斑紋", origin:"南非", habit:"成蟲具備攀爬光滑表面和飛行的能力，但牠們更喜歡將時間花在底材下，幼蟲則完全無法攀爬光滑表面", diet:"雜食性，高蛋白飼料、蔬果、落葉", temp:"24–28°C；60–70%", diff:1, tags:["現貨","新手友善"], info:"生命週期穩定、適應力佳", img:"images/IMG_9555.JPG"},
    {genus:"Gyna", species:"centurio", latin:"Gyna centurio", cn:"百夫長瓷蠊", stock: "in-stock", appearance: "質感", price: 400, pack: 6, features:"雌雄二型明顯，雄米白、雌深褐斑為主", origin:"非洲中部", habit:"成蟲同樣具備攀爬光滑表面和飛行的能力，但相較於卡佛爾瓷蠊，本種速度較慢", diet:"雜食性，高蛋白飼料、蔬果、落葉", temp:"24–28°C；60–70%", diff:1, tags:["現貨","新手友善"], info:"繁殖容易，環境要求低", img:"images/IMG_9552.JPG"},
    // 馬島群
