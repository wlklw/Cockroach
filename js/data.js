...
const DATA = [
    ...
    // 瓷蠊屬
    {genus:"Gyna", species:"caffrorum", latin:"Gyna caffrorum", cn:"卡佛爾瓷蠊", stock: "in-stock", appearance: "質感", price: 300, pack: 6, features:"淡米至淺棕翅，細緻斑紋", origin:"南非", habit:"成蟲具備攀爬光滑表面和飛行的能力，但牠們更喜歡將時間花在底材下，幼蟲則完全無法攀爬光滑表面", diet:"雜食性，高蛋白飼料、蔬果、落葉", temp:"24–28°C；60–70%", diff:1, tags:["現貨","新手友善"], info:"生命週期穩定、適應力佳", img:"IMG_9555.JPG"},
